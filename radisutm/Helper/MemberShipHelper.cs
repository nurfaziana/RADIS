...
namespace radisutm.Helper
{
    public class MemberShipHelper : MembershipProvider
    {
        ...
        public UserModel GetUserProfile(string username, string password)
        {
            var user =
                _userRepository.All().FirstOrDefault(x => x.ID_PENGGUNA == username && x.KAD_PENGENALAN == password);
            return user;
        }
